...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"MSAS - Ministère de la santé et de l'action sociale","titleTemplate":"ACVDT | %s","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.png"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_axios_72c162fe === 'function') {
    await nuxt_plugin_axios_72c162fe(app.context, inject)
  }
