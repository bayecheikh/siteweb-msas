...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"MSAS - Ministère de la santé et de l'action sociale","titleTemplate":"MSAS | %s","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.png"}],"style":[],"script":[]},
